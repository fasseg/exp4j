...
abstract class RPNConverter {
    ...
    static RPNExpression toRPNExpression(String infix,Map<String,Double> variables,Map<String,CustomFunction> customFunctions,Map<Character,Operation> operators) throws UnknownFunctionException, UnparsableExpressionException{
