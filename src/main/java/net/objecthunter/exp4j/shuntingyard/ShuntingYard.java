    ...
    public static Token[] convertToRPN(final String expression, final Map<String, Function> userFunctions,
        ...
        while (tokenizer.hasNext()) {
            ...
            case TokenType.SEPARATOR:
                while (!stack.empty() && stack.peek().getType() != TokenType.PARENTHESES_OPEN) {
                    output.add(stack.pop());
                }
                if (stack.empty() || stack.peek().getType() != TokenType.PARENTHESES_OPEN) {
        ...
        while (!stack.empty()) {
            Token t = stack.pop();
            if (t.getType() == TokenType.PARENTHESES_CLOSE || t.getType() == TokenType.PARENTHESES_OPEN) {
