    ...
    public Token nextToken(){
        ...
        if (Character.isDigit(ch) || ch == '.') {
            if (lastToken != null) {
                ...
                } else if (implicitMultiplication && (lastToken.getType() != TokenType.OPERATOR
                        && lastToken.getType() != TokenType.PARENTHESES_OPEN
                        && lastToken.getType() != TokenType.FUNCTION
                        && lastToken.getType() != TokenType.SEPARATOR)) {
    ...
    private Operator getOperator(String symbol) {
        ...
        if (op == null && symbol.length() == 1) {
            ...
            if (lastToken == null) {
                ...
                if (lastTokenType == TokenType.PARENTHESES_OPEN || lastTokenType == TokenType.SEPARATOR) {
                    argc = 1;
