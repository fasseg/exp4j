...
public class FastTokenizer {
    ...
    public FastTokenizer(final char[] data, final Map<String, Double> variables, final Map<String, Function> customFunctions,
    ...
    public FastTokenizer(final String expression, final Map<String, Double> variables, final Map<String, Function> customFunctions,
            final Map<String, Operator> customOperators) {
        this(expression.toCharArray(), variables, customFunctions, customOperators);
    }
    ...
    public FastTokenizer(final String expression, final Map<String, Double> variables) {
        ...
        if (Character.isDigit(ch) || ch == '.') {
            ...
            if (isOperatorPrefix(ch)) {
                ...
                if (isOperator(tmp)) {
                    ...
                    throw new UnparseableExpressionException("Unknown operator '" + tmp);
                }
                if (this.currentType == Token.OPERATOR || this.currentType == 0 || this.currentType == Token.PARANTHESES_LEFT
                ...
                throw new UnparseableExpressionException("Unknown operator '" + valBuilder.toString());
            }
    ...
    private Function getFunction(String name) {
        Function func = Functions.getBuiltinFunction(name);
