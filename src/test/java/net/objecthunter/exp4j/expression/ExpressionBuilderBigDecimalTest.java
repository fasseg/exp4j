...
public class ExpressionBuilderBigDecimalTest {
    ...
    public void testExpression1() throws Exception {
        String exp = "2+3";
        BigDecimal result = new ExpressionBuilder(exp).buildBigDecimal().evaluate();
    ...
    public void testExpression3() throws Exception {
        String exp = "sum(1,1)";
        BigDecimal result = new ExpressionBuilder(exp).function(new Function<BigDecimal>("sum",2) {
            @Override
    ...
    public void testExpression4() throws Exception {
        ...
        BigDecimal result = new ExpressionBuilder(exp).function(new Function<BigDecimal>("sum",-1) {
            @Override
            public BigDecimal apply(BigDecimal... args) {
    ...
    public void testExpression5() throws Exception {
        String expr = "2#2";
        Operator op = new Operator<BigDecimal>("#",2,true,Operators.PRECEDENCE_ADDITION) {
            @Override
            public BigDecimal apply(BigDecimal... args) {
                return args[0].add(args[1]);
            }
    ...
    public void testExpression6() throws Exception {
        String expr = "11!";
        Operator op = new Operator<BigDecimal>("!",1,false,Operators.PRECEDENCE_MULTIPLICATION) {
            @Override
            public BigDecimal apply(BigDecimal... args) {
