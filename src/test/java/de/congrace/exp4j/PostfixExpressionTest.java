...
public class PostfixExpressionTest {
	...
	public void testExpression15() throws Exception {
		...
		double expected = 2.5333333333d * 17.41d + Math.pow((12 * 2),
				Math.log(2.764d));
		pe = PostfixExpression.fromInfix(expr);
		assertTrue(expected == pe.calculate());
	}
	...
	public void testExpression16() throws Exception {
		...
		double expected = 2.5333333333d / 2 * 17.41d + Math.pow((12 * 2),
				Math.log(2.764d) - Math.sin(5.6664d));
		pe = PostfixExpression.fromInfix(expr);
		assertTrue(expected == pe.calculate());
	}
	...
	public void testPostfixEverything() throws Exception {
		...
		expected = (Math.sin(12) + Math.log(34)) * 3.42
				- Math.cos(2.234 - Math.log(2));
		pe = PostfixExpression.fromInfix(expr);
		assertTrue(expected == pe.calculate());
	}
